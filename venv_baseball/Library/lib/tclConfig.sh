...
# installed.
TCL_PREFIX='E:/baseball_stats_prediction_project/venv_baseball\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/baseball_stats_prediction_project/venv_baseball\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/baseball_stats_prediction_project/venv_baseball\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/baseball_stats_prediction_project/venv_baseball\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/baseball_stats_prediction_project/venv_baseball\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/baseball_stats_prediction_project/venv_baseball\Library\lib\tclstub86.lib'
